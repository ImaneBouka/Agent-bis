...
var ExecutionHandler = function (connection, broker, executor, channel, statusSilo, logger) {
    //private member
    ...
    function addStatusMessageFeatures(message) {
        console.log("entering addStatusMessageFeatures!!");
    ...
    function doOnMessage(payload, onTmpChannel) {
        ...
        g_eikonVersion.getEIKONVersion()
            .then(function versionFound(eikonVersion) {
                var l_executionMessage = addStatusMessageFeatures(payload.content);
                var l_executionAcknowledgmentMessage = {
                    executionID: l_executionMessage.executionID,
                    agentStatus: 'Running',
                    eikonVersion: eikonVersion,
                    deliveryTag: payload.content._tag
                };
